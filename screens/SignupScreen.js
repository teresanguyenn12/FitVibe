...
const styles = StyleSheet.create({
  ...
  input: { backgroundColor: "#1e1e1e", color: "white", padding: 15, borderRadius: 8, marginBottom: 10, borderWidth: 1, borderColor: "#333" },
  datePicker: { flexDirection: "row", backgroundColor: "#1e1e1e", padding: 15, borderRadius: 8, borderWidth: 1, borderColor: "#333", marginBottom: 10, alignItems: "center", justifyContent: "space-between" },
  dateText: { color: "white" },
  placeholderText: { color: "#aaa" },
  genderPicker: { flexDirection: "row", backgroundColor: "#1e1e1e", padding: 15, borderRadius: 8, borderWidth: 1, borderColor: "#333", marginBottom: 10, alignItems: "center", justifyContent: "space-between" },
  genderText: { color: "white" },
  pickerContainer: { backgroundColor: "#1e1e1e", borderRadius: 8, borderWidth: 1, borderColor: "#333", marginBottom: 10 },
  picker: { color: "white" },
  button: { padding: 15, borderRadius: 50, alignItems: "center", justifyContent: "center", marginTop: 10 },
