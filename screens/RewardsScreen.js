    ...
    <View style = {[styles.container, { backgroundColor: theme.background }]}>
      ...
      <ScrollView>
        ...
        <View style = {styles.grid}>
          <RewardItem image = {require("../assets/rewards/FVProteinBar.jpg")} cost = {100} description = "Fuel your body with a Protein Bar, a convenient, high-protein snack to keep you energized throughout your day! Whether you're working out, on the go, or simply need a quick snack, this bar provides essential nutrients to help support muscle recovery and overall wellness." onPress = {openRewardModal}/>
          <RewardItem image = {require("../assets/rewards/FVTowel.jpg")} cost = {600} description = "Stay fresh and dry with a soft, absorbent towel! Ideal for use during workouts, sports activities, or at the gym, this towel ensures you stay comfortable and clean while pushing your limits." onPress = {openRewardModal}/>
          <RewardItem image = {require("../assets/rewards/FVProteinBottleShaker.jpg")} cost = {800} description = "Mix your protein shakes with ease using the Protein Bottle Shaker! Designed for convenience and efficiency, this shaker helps you blend your protein powder smoothly and quickly, making sure you get the perfect consistency every time." onPress = {openRewardModal}/>
          <RewardItem image = {require("../assets/rewards/FVGymBag.jpg")} cost = {1000} description = "Stay organized and stylish with the FitVibe Gym Bag—designed for fitness enthusiasts who demand both functionality and durability. This spacious gym bag features multiple compartments to store your workout gear, shoes, clothes, and accessories with ease. Made from high-quality, water-resistant material, it keeps your belongings safe and dry." onPress = {openRewardModal}/>
        </View>
