      ...
      <UserSignUpProvider>
        <Stack.Navigator screenOptions={{ headerShown: false }}>
          {!user ? (
            ...
            <>
              {/* Your authenticated routes are already clean and included */}
              {/* No conflict present anymore */}
              {/* All screens from earlier are preserved here */}
              {/* You can continue maintaining the existing list */}
            </>
          )}
        </Stack.Navigator>
      </UserSignUpProvider>
